...
public class MortgageCalculator3_Ternaries {
    ...
    public static void main(String[] args) {
        ...
        //Determine the annual interest rates for different loan types with ternaries
        double annualInterestRate=(loanType=="Fixed"&& loanTermInYears==30)? 7.5 :(loanType=="Fixed"&& loanTermInYears==15)? 6.9 : (loanType=="FHA"&& loanTermInYears==30)? 7.24 :(loanType=="FHA"&& loanTermInYears==15)? 6.62 : (loanType=="VA"&& loanTermInYears==30)? 6.75 : (loanType=="VA"&& loanTermInYears==15)? 5.99 : 0.0;
